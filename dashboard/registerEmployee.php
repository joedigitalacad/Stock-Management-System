    ...
    <div class="card mx-auto mt-2">
      ...
      <div class="card-body">
      	<?php if (isset($_GET['success']) && $_GET['success'] == true): ?>
      		<div class="bg-success p-3 mb-3" style="color: #fff;">Employee has been successfully Registered in the system</div>
      	<?php endif ?>
        <form method="post" action="../controller/registerEmployee.php">
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="username" name="username" class="form-control" placeholder="Last name" required="required">
